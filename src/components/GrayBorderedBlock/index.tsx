...
const GrayBorderedBlock: FC<HasChildrenProps & HasClassName & GrayBorderedBlock> = ({ className, disabledBorder = false, labelFor, clickHandler, disabled, validError, isFocused, children }) => {
